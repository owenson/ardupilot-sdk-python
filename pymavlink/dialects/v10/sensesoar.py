...
class MAVLink_obs_velocity_message(MAVLink_message):
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 108, struct.pack('<3f', self.vel))
...
class MAVLink_obs_attitude_message(MAVLink_message):
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 146, struct.pack('<4d', self.quat))
...
class MAVLink_obs_wind_message(MAVLink_message):
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 16, struct.pack('<3f', self.wind))
...
class MAVLink_obs_bias_message(MAVLink_message):
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 159, struct.pack('<3f3f', self.accBias, self.gyroBias))
...
class MAVLink_filt_rot_vel_message(MAVLink_message):
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 79, struct.pack('<3f', self.rotVel))
...
class MAVLink_llc_out_message(MAVLink_message):
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 5, struct.pack('<4h2h', self.servoOut, self.MotorOut))
...
class MAVLink_pm_elec_message(MAVLink_message):
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 170, struct.pack('<ff3f', self.PwCons, self.BatStat, self.PwGen))
...
mavlink_map = {
        MAVLINK_MSG_ID_OBS_POSITION : ( '<iii', MAVLink_obs_position_message, [0, 1, 2], 15 ),
        MAVLINK_MSG_ID_OBS_VELOCITY : ( '<3f', MAVLink_obs_velocity_message, [0], 108 ),
        MAVLINK_MSG_ID_OBS_ATTITUDE : ( '<4d', MAVLink_obs_attitude_message, [0], 146 ),
        MAVLINK_MSG_ID_OBS_WIND : ( '<3f', MAVLink_obs_wind_message, [0], 16 ),
        MAVLINK_MSG_ID_OBS_AIR_VELOCITY : ( '<fff', MAVLink_obs_air_velocity_message, [0, 1, 2], 32 ),
        MAVLINK_MSG_ID_OBS_BIAS : ( '<3f3f', MAVLink_obs_bias_message, [0, 1], 159 ),
        MAVLINK_MSG_ID_OBS_QFF : ( '<f', MAVLink_obs_qff_message, [0], 24 ),
        MAVLINK_MSG_ID_OBS_AIR_TEMP : ( '<f', MAVLink_obs_air_temp_message, [0], 248 ),
        MAVLINK_MSG_ID_FILT_ROT_VEL : ( '<3f', MAVLink_filt_rot_vel_message, [0], 79 ),
        MAVLINK_MSG_ID_LLC_OUT : ( '<4h2h', MAVLink_llc_out_message, [0, 1], 5 ),
        MAVLINK_MSG_ID_PM_ELEC : ( '<ff3f', MAVLink_pm_elec_message, [0, 1, 2], 170 ),
        MAVLINK_MSG_ID_SYS_STAT : ( '<BBBB', MAVLink_sys_stat_message, [0, 1, 2, 3], 157 ),
        MAVLINK_MSG_ID_CMD_AIRSPEED_CHNG : ( '<fB', MAVLink_cmd_airspeed_chng_message, [1, 0], 209 ),
        MAVLINK_MSG_ID_CMD_AIRSPEED_ACK : ( '<fB', MAVLink_cmd_airspeed_ack_message, [0, 1], 243 ),
