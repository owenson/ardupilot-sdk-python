...
class MAVLink_cpu_load_message(MAVLink_message):
        ...
        def __init__(self, sensLoad, ctrlLoad, batVolt):
                MAVLink_message.__init__(self, MAVLINK_MSG_ID_CPU_LOAD, 'CPU_LOAD')
                self._fieldnames = ['sensLoad', 'ctrlLoad', 'batVolt']
...
class MAVLink_air_data_message(MAVLink_message):
        ...
        def __init__(self, dynamicPressure, staticPressure, temperature):
                MAVLink_message.__init__(self, MAVLINK_MSG_ID_AIR_DATA, 'AIR_DATA')
                self._fieldnames = ['dynamicPressure', 'staticPressure', 'temperature']
...
class MAVLink_sensor_bias_message(MAVLink_message):
        ...
        def __init__(self, axBias, ayBias, azBias, gxBias, gyBias, gzBias):
                MAVLink_message.__init__(self, MAVLINK_MSG_ID_SENSOR_BIAS, 'SENSOR_BIAS')
                self._fieldnames = ['axBias', 'ayBias', 'azBias', 'gxBias', 'gyBias', 'gzBias']
                self.axBias = axBias
                self.ayBias = ayBias
                self.azBias = azBias
                self.gxBias = gxBias
...
class MAVLink_diagnostic_message(MAVLink_message):
        ...
        def __init__(self, diagFl1, diagFl2, diagFl3, diagSh1, diagSh2, diagSh3):
                ...
                self._fieldnames = ['diagFl1', 'diagFl2', 'diagFl3', 'diagSh1', 'diagSh2', 'diagSh3']
...
class MAVLink_slugs_navigation_message(MAVLink_message):
        ...
        def __init__(self, u_m, phi_c, theta_c, psiDot_c, ay_body, totalDist, dist2Go, fromWP, toWP):
                MAVLink_message.__init__(self, MAVLINK_MSG_ID_SLUGS_NAVIGATION, 'SLUGS_NAVIGATION')
                self._fieldnames = ['u_m', 'phi_c', 'theta_c', 'psiDot_c', 'ay_body', 'totalDist', 'dist2Go', 'fromWP', 'toWP']
                self.u_m = u_m
                self.phi_c = phi_c
...
class MAVLink_data_log_message(MAVLink_message):
        ...
        def __init__(self, fl_1, fl_2, fl_3, fl_4, fl_5, fl_6):
                MAVLink_message.__init__(self, MAVLINK_MSG_ID_DATA_LOG, 'DATA_LOG')
                self._fieldnames = ['fl_1', 'fl_2', 'fl_3', 'fl_4', 'fl_5', 'fl_6']
                self.fl_1 = fl_1
                self.fl_2 = fl_2
                self.fl_3 = fl_3
                self.fl_4 = fl_4
...
class MAVLink_gps_date_time_message(MAVLink_message):
        ...
        def __init__(self, year, month, day, hour, min, sec, visSat):
                MAVLink_message.__init__(self, MAVLINK_MSG_ID_GPS_DATE_TIME, 'GPS_DATE_TIME')
                self._fieldnames = ['year', 'month', 'day', 'hour', 'min', 'sec', 'visSat']
                self.year = year
                self.month = month
                self.day = day
                self.hour = hour
...
class MAVLink_mid_lvl_cmds_message(MAVLink_message):
        ...
        def __init__(self, target, hCommand, uCommand, rCommand):
                MAVLink_message.__init__(self, MAVLINK_MSG_ID_MID_LVL_CMDS, 'MID_LVL_CMDS')
                self._fieldnames = ['target', 'hCommand', 'uCommand', 'rCommand']
                self.target = target
...
class MAVLink_ctrl_srfc_pt_message(MAVLink_message):
        ...
        def __init__(self, target, bitfieldPt):
                MAVLink_message.__init__(self, MAVLINK_MSG_ID_CTRL_SRFC_PT, 'CTRL_SRFC_PT')
                self._fieldnames = ['target', 'bitfieldPt']
                self.target = target
...
class MAVLink_slugs_action_message(MAVLink_message):
        ...
        def __init__(self, target, actionId, actionVal):
                MAVLink_message.__init__(self, MAVLINK_MSG_ID_SLUGS_ACTION, 'SLUGS_ACTION')
                self._fieldnames = ['target', 'actionId', 'actionVal']
                self.target = target
                self.actionId = actionId
                self.actionVal = actionVal

        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 65, struct.pack('<HBB', self.actionVal, self.target, self.actionId))
...
mavlink_map = {
        MAVLINK_MSG_ID_CPU_LOAD : ( '<HBB', MAVLink_cpu_load_message, [1, 2, 0], 75 ),
        MAVLINK_MSG_ID_AIR_DATA : ( '<ffH', MAVLink_air_data_message, [0, 1, 2], 232 ),
        MAVLINK_MSG_ID_SENSOR_BIAS : ( '<ffffff', MAVLink_sensor_bias_message, [0, 1, 2, 3, 4, 5], 168 ),
        MAVLINK_MSG_ID_DIAGNOSTIC : ( '<fffhhh', MAVLink_diagnostic_message, [0, 1, 2, 3, 4, 5], 2 ),
        MAVLINK_MSG_ID_SLUGS_NAVIGATION : ( '<fffffffBB', MAVLink_slugs_navigation_message, [0, 1, 2, 3, 4, 5, 6, 7, 8], 120 ),
        MAVLINK_MSG_ID_DATA_LOG : ( '<ffffff', MAVLink_data_log_message, [0, 1, 2, 3, 4, 5], 167 ),
        MAVLINK_MSG_ID_GPS_DATE_TIME : ( '<BBBBBBB', MAVLink_gps_date_time_message, [0, 1, 2, 3, 4, 5, 6], 16 ),
        MAVLINK_MSG_ID_MID_LVL_CMDS : ( '<fffB', MAVLink_mid_lvl_cmds_message, [3, 0, 1, 2], 146 ),
        MAVLINK_MSG_ID_CTRL_SRFC_PT : ( '<HB', MAVLink_ctrl_srfc_pt_message, [1, 0], 104 ),
        MAVLINK_MSG_ID_SLUGS_ACTION : ( '<HBB', MAVLink_slugs_action_message, [1, 2, 0], 65 ),
...
class MAVLink(object):
        ...
        def cpu_load_encode(self, sensLoad, ctrlLoad, batVolt):
                ...
                '''
                msg = MAVLink_cpu_load_message(sensLoad, ctrlLoad, batVolt)
                msg.pack(self)
                return msg
        ...
        def air_data_encode(self, dynamicPressure, staticPressure, temperature):
                ...
                '''
                msg = MAVLink_air_data_message(dynamicPressure, staticPressure, temperature)
                msg.pack(self)
                return msg
        ...
        def sensor_bias_encode(self, axBias, ayBias, azBias, gxBias, gyBias, gzBias):
                ...
                '''
                msg = MAVLink_sensor_bias_message(axBias, ayBias, azBias, gxBias, gyBias, gzBias)
                msg.pack(self)
                return msg
        ...
        def diagnostic_encode(self, diagFl1, diagFl2, diagFl3, diagSh1, diagSh2, diagSh3):
                ...
                '''
                msg = MAVLink_diagnostic_message(diagFl1, diagFl2, diagFl3, diagSh1, diagSh2, diagSh3)
                msg.pack(self)
                return msg
        ...
        def slugs_navigation_encode(self, u_m, phi_c, theta_c, psiDot_c, ay_body, totalDist, dist2Go, fromWP, toWP):
                ...
                '''
                msg = MAVLink_slugs_navigation_message(u_m, phi_c, theta_c, psiDot_c, ay_body, totalDist, dist2Go, fromWP, toWP)
                msg.pack(self)
                return msg
        ...
        def data_log_encode(self, fl_1, fl_2, fl_3, fl_4, fl_5, fl_6):
                ...
                '''
                msg = MAVLink_data_log_message(fl_1, fl_2, fl_3, fl_4, fl_5, fl_6)
                msg.pack(self)
                return msg
        ...
        def gps_date_time_encode(self, year, month, day, hour, min, sec, visSat):
                ...
                '''
                msg = MAVLink_gps_date_time_message(year, month, day, hour, min, sec, visSat)
                msg.pack(self)
                return msg
        ...
        def mid_lvl_cmds_encode(self, target, hCommand, uCommand, rCommand):
                ...
                '''
                msg = MAVLink_mid_lvl_cmds_message(target, hCommand, uCommand, rCommand)
                msg.pack(self)
                return msg
        ...
        def ctrl_srfc_pt_encode(self, target, bitfieldPt):
                ...
                '''
                msg = MAVLink_ctrl_srfc_pt_message(target, bitfieldPt)
                msg.pack(self)
                return msg
        ...
        def slugs_action_encode(self, target, actionId, actionVal):
                ...
                '''
                msg = MAVLink_slugs_action_message(target, actionId, actionVal)
                msg.pack(self)
                return msg
